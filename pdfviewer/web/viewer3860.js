...
{
    var HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io', 'http://dvpapi3.dienthoaihaiphong.com', 'http://192.168.2.6:96', 'http://cangdinhvu.vn', 'http://dinhvuport.com.vn', 'https://cangdinhvu.vn', 'https://dinhvuport.com.vn'];
  validateFileURL = function validateFileURL(file) {
    ...
    try {
      ...
      if (origin !== viewerOrigin && protocol !== 'blob:') {
          throw new Error('file origin does not match viewer\'s' + "|"+ origin + "|"+ viewerOrigin);
      }
    } catch (ex) {
...
var DEFAULT_SCALE_VALUE = 'page-width'; //'auto';
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt('return', 'vi');
...
};
{
  defaultOptions.locale = {
    value: typeof navigator !== 'undefined' ? navigator.language : 'vi',
    kind: OptionKind.VIEWER
  };
}
...
var NON_METRIC_LOCALES = ['vi', 'en-lr', 'my'];
var US_PAGE_NAMES = {
  '8.5x11': 'Letter',
  '8.5x14': 'Legal'
};
...
GenericExternalServices.createL10n = function (_ref3) {
  var _ref3$locale = _ref3.locale,
      locale = _ref3$locale === undefined ? 'vi' : _ref3$locale;
locale='vi';
